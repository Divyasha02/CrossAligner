...
#candidate_file = (
 #   "/vast/ve83rur/OntoAligner/bash/"
  #  "results/Qwen3-32B/"
   # "Qwen3-32B_raw_s_f_occo_ons_deeponto_stage1_case4.json"
...
target_enricher = DeepOntoAxiomEnricher(
    ontology_path="/vast/ve83rur/OntoAligner/assets/food-onto/ons.owl",
    max_axioms_per_class=8,
    include_named_subclass_axioms=False,
    jvm_memory="4g",
)
...
out = pipe(
    ...
    llm_prompt_preview_count=40,                       # For all the input to the prompt print in log # llm_prompt_preview_count=14, by default to 0
...
run_name = "Llama_Stage1_Llama-3.3-70B-Instruct_raw_s_f_mesh_ons_stage2_case6_without_eg_2-1_new_mesh_ons"
