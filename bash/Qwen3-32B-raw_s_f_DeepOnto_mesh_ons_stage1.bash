...
target_candidate_root_iris = [
    "http://purl.obolibrary.org/obo/FOODON_00002403",             # Food Material: includes food products and diets
    "http://purl.obolibrary.org/obo/FOODON_03420116",                # Organism Material: includes animal/algae materials
]
            
pipe = OntoAlignerPipeline(
    task_class=GenericOMDataset,
    source_ontology_path="assets/food-onto/mesh.owl",   # assets/food-onto/occo.owl  # mesh.owl
...
out = pipe(
    ...
    max_length=800,
    max_new_tokens=10,
    output_file_name="qwen3_32b_s_f_mesh_ons",
    save_matchings=True,
...
# raw-mode export
run_name = "Qwen3-32B_raw_s_f_mesh_ons_deeponto_stage1_case4"                     #"Qwen3-32B_raw_s_f_mesh_ons_binary"
out_dir = "results/Qwen3-32B"

#run_name = "Llama-3.3-70B-Instruct_raw_s_f_mesh_ons_deeponto_stage1_case4"
